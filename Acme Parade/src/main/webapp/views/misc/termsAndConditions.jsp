...
<jstl:if test="${language == 'en'}">
	<h2>Welcome to Acme Madrugá</h2>
	<p>These terms and conditions outline the rules and regulations for the use of Acme Madrugá's Website.</p> <br /> 
	
	<p>By accessing this website we assume you accept these terms and conditions in full. Do not continue to use Acme Madrugá's website 
	...
	<h2>License</h2>
	<p>Unless otherwise stated, Acme Madrugá and/or it's licensors own the intellectual property rights for
	all material on Acme Madrugá. All intellectual property rights are reserved. You may view and/or print
	pages from https://Acme-Madruga.com for your own personal use subject to restrictions set in these terms and conditions.</p>
	<p>You must not:</p>
	<ol>
		<li>Republish material from https://Acme-Madruga.com</li>
		<li>Sell, rent or sub-license material from https://Acme-Madruga.com</li>
		<li>Reproduce, duplicate or copy material from https://Acme-Madruga.com</li>
	</ol>
	<p>Redistribute content from Acme Madrugá (unless content is specifically made for redistribution).</p>
<h2>User Comments</h2>
	<ol>
		<li>This Agreement shall begin on the date hereof.</li>
		<li>Certain parts of this website offer the opportunity for users to post and exchange opinions, information,
		material and data ('Comments') in areas of the website. Acme Madrugá does not screen, edit, publish
		or review Comments prior to their appearance on the website and Comments do not reflect the views or
		opinions of Acme Madrugá, its agents or affiliates. Comments reflect the view and opinion of the
		person who posts such view or opinion. To the extent permitted by applicable laws Acme Madrugá shall
		...
		website.</li>
		<li>Acme Madrugá reserves the right to monitor all Comments and to remove any Comments which it considers
		...
		<li>You hereby grant to <strong>Acme Madrugá</strong> a non-exclusive royalty-free license to use, reproduce,
...
<h2>Hyperlinking to our Content</h2>
	...
	you must notify us by sending an e-mail to acme-madruga@acme.com.
	...
	<p>No use of Acme Madrugá's logo or other artwork will be allowed for linking absent a trademark license
	agreement.</p>
<h2>Iframes</h2>
...
<jstl:if test="${language == 'es'}">
	<h2> Bienvenido a Acme Madrugá </h2>
	<p> Estos términos y condiciones describen las reglas y regulaciones para el uso del sitio web de Acme Madrugá. </p> <br />

	<p> Al acceder a este sitio web, asumimos que acepta estos términos y condiciones en su totalidad. No sigas utilizando la web de Acme Madrugá.
	...
	<h2> Licencia </h2>
	<p> A menos que se indique lo contrario, Acme Madrugá y / o sus licenciatarios poseen los derechos de propiedad intelectual de
	todo el material sobre Acme Madrugá. Todos los derechos de propiedad intelectual están reservados. Usted puede ver y / o imprimir
	páginas de https://Acme-Madruga.com para su uso personal sujeto a las restricciones establecidas en estos términos y condiciones. </p>
	<p> No debes: </p>
	<ol>
		<li> Volver a publicar material desde https://Acme-Madruga.com </li>
		<li> Vender, alquilar o sub-licenciar material de https://Acme-Madruga.com </li>
		<li> Reproducir, duplicar o copiar material de https://Acme-Madruga.com </li>
	</ol>
	<p> Redistribuir el contenido de Acme Madrugá (a menos que el contenido se haga específicamente para la redistribución). </p>
<h2> Comentarios de usuarios </h2>
	<ol>
		...
		Material y datos ('Comentarios') en áreas del sitio web. Acme Madrugá no proyecta, edita, publica
		o comentarios de revisión antes de su aparición en el sitio web y comentarios no reflejan las vistas u
		opiniones de Acme Madrugá, sus agentes o afiliados. Los comentarios reflejan la opinión y opinión de la
		persona que publica tal opinión. En la medida permitida por las leyes aplicables, Acme Madrugá
		...
		sitio web. </li>
		<li> Acme Madrugá se reserva el derecho de monitorear todos los comentarios y eliminar cualquier comentario que considere
		...
		<li> Por la presente, usted otorga a <strong> Acme Madrugá </strong> una licencia no exclusiva sin royalties para usar, reproducir y
...
<h2> Hiperenlaces a nuestro contenido </h2>
	...
	debe notificarnos enviando un correo electrónico a acme-madruga@acme.com.
	...
	<p> No se permitirá el uso del logotipo de Acme Madrugá u otra obra de arte para enlazar en ausencia de una licencia de marca registrada
	acordada. </p>
<h2> Iframes </h2>
